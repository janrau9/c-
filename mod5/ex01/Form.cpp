...
/*   Updated: 2024/07/02 13:27:58 by jberay           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
    ...
    : name(name), isSigned(false)
{
    ...
    this->getGradeRequiredToSign = getGradeRequiredToSign;
    if (gradeRequiredToExecute < 1)
        throw Form::GradeTooHighException();
    else if (gradeRequiredToExecute > 150)
        throw Form::GradeTooLowException();
    this->getGradeRequiredToExecute = getGradeRequiredToExecute;
}
...
{
    os << "Name: " << F.getName() << std::endl << "Grade: " << F.getGrade() << std::endl \
